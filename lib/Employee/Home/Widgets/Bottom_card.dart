  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border(
          bottom: BorderSide(
              color: BottomCardConfig.borderColor,
              width: BottomCardConfig.borderWidth), // ✅ Bottom Border
          left: BorderSide(
              color: BottomCardConfig.borderColor,
              width: BottomCardConfig.borderWidth), // ✅ Left Border
          right: BorderSide(
              color: BottomCardConfig.borderColor,
              width: BottomCardConfig.borderWidth), // ✅ Right Border
