...
class WelcomeCardConfig {
  ...
  static final TextStyle nameText =
      AppTextStyles.textStyle(fontSize: 24, fontWeight: FontWeight.w500);
  static final TextStyle roleText =
      AppTextStyles.textStyle(fontWeight: FontWeight.w500);
}
...
class LeaveContainerConfig {
  ...
  static const Color defaultColor =
      Colors.white; // Equivalent to Colors.grey[200]
